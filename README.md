<h1 align="center">Mehmet Emin Coban</h1>

<p align="center">
  <strong>Full-Stack Developer & AI/ML Engineer</strong><br>
...
Software engineer with a background in Electrical Engineering and Digital Marketing. I build full-stack web applications, SaaS products, and machine learning systems. Focused on combining AI with real-world business problems — from sales intelligence to price prediction.
...
|---------|-------------|-------|
| **Ads Pulse** | SaaS platform for ad performance analytics with Chrome Extension | Next.js, Supabase, Chrome API |
| **Immo-Eliza** | ML model predicting real estate prices across Belgium | Python, Scikit-learn, FastAPI |
| **Amazon Scraper** | Price comparison tool finding arbitrage opportunities across Amazon regions | Python, Selenium, BeautifulSoup |
| **Churn Rate Analysis** | Customer churn prediction and analysis pipeline | Python, Pandas, Scikit-learn |
| **US Airline Tweets** | NLP sentiment analysis on airline customer feedback | Python, NLP, Data Visualization |
| **GDP Dashboard** | Interactive economic data visualization dashboard | Python, Streamlit |
...
<p align="center">
  <em>Open to collaboration on AI/ML, SaaS, and full-stack projects.</em>
</p>
